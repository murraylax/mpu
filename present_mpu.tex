...
\frame
{
  ...
  \item Uncertainty
  \item and the Impact on the Macroeconomy
  \ee
}
...
\frame
{
  \ft{Monetary Policy 101: Introduction}
  \bi
...
\frame
{
  \ft{Monetary Policy 102: Addressing Unemployment}
...
\frame
{
  \ft{Monetary Policy 103: Addressing Inflation}
...
\frame
{
  \ft{Monetary Policy 499: Capstone}
  \bi
...
\frame
{
  ...
  \uncover<+->{What impact does MPU have on levels of...}
    \be
    \item<.-> Unemployment,
    \item<.-> Production growth,
    \item<.-> inflation.
    \ee
  \uncover<+->{Estimate a Vector Autoregression (VAR):}
    \bi
...
\frame
{
  ...
  \begin{scriptsize}
    ...
    \begin{tabular}{l|ll|ll|ll}
      ...
      $MPU_{t}$ &  -0.017 & (0.088)    &  0.070 & (0.046)    &  -0.072 & (0.112)      \\ \hline
...
$MPU_{t}^2$ & 0.022 & (0.015) & 0.006*** & (0.002) & 0.033** & (0.014)  \\ \hline
...
\bi
\item Statistical significance on $MPU$ implies monetary policy uncertainty leads to less stability in unemployment and output growth.
\item Failure to find significance for inflation equation implies failure to find evidence uncertainty affects inflation volatility.
\ei 
}
